...
export default class CheckerboardView extends Component{
  ...
  render() {
    ...
    avatarLeft.marginLeft = `${-avatarIconWidth}px`
    ...
    avatarRight.marginRight = `${-avatarIconWidth}px`
...
const styles = {
  ...
  avatar: {
    display: 'flex',
    flexDirection: 'column',
    width: `${avatarIconWidth*2}px`,
    height: `${avatarIconWidth*2}px`,
    transform: 'rotate(135deg)',
    marginTop: `${rotateGapWidth}px`,
    borderRadius: `10px`,
  },
  avatar_icon: {
    width: `${avatarIconWidth}px`,
    height: `${avatarIconWidth}px`,
    transform: 'rotate(-135deg)',
    margin: `4px`
  },
  middle : {
    ...
    display:'flex',
    flexDirection: 'column',
    marginLeft: `${rotateGapWidth*2}px`,
    marginRight: `${rotateGapWidth*2}px`,
  },
  middle_title: {
    fontSize: `18px`,
    fontWeight: 'bold',
